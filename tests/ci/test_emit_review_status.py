...
def test_ci_review_status_links_to_each_sensitive_file_change():
    results = _mod.build_results(
        ...
        supply_chain=False,
        label_present=False,
        ci_review_files='[".github/workflows/ci.yml", "scripts/whatsapp-bridge/eslint.config.mjs"]',
    ...
    assert results[0]["detail"] == (
        ...
        "- [`scripts/whatsapp-bridge/eslint.config.mjs`](https://github.com/nousresearch/hermes-agent/compare/base456...abc123#diff-68e14fd1792ca6c7a5fb705cba52c5191983899b72249f5efd72556ad0e707b3)"
    )
