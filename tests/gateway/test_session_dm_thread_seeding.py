...
def _dm_source(platform=Platform.MATTERMOST, chat_id="D123", thread_id=None, user_id="U1"):
...
def _group_source(platform=Platform.MATTERMOST, chat_id="C456", thread_id=None, user_id="U1"):
    return SessionSource(
        platform=platform,
        chat_id=chat_id,
        chat_type="group",
...
class TestDMThreadIsolationCrossPlatform:
    ...
    @pytest.mark.parametrize("platform", [Platform.MATTERMOST, Platform.TELEGRAM, Platform.TELEGRAM])
