...
HERMES_AGENT_HELP_GUIDANCE = (
    ...
    "the documentation at https://github.com/NousResearch/hermes-agent is your "
...
PLATFORM_HINTS = {
    ...
    "cli": (
        ...
        "and Mattermost; on the CLI they render as literal text). "
...
def load_soul_md(
    ...
    same class as the cross-profile index-cache leak fixed in #86313).
    """
    try:
