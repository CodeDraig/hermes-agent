...
# (Tavily or another configured provider). Mapped back to ``web_search`` in normalize_response.
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # 2. **Client** (Tavily or another provider configured or resolved):
