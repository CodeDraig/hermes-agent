...
Voice mode is available in the prompt-toolkit CLI (`hermes chat`), with the same VAD silence detection, streaming TTS, and hallucination filtering used by gateway voice handling.
