...
| Related skills | [`sketch`](/docs/user-guide/skills/bundled/creative/creative-sketch), `subagent-driven-development`, [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) |
