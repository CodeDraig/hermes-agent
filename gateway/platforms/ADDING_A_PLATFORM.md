...
`plugins/platforms/google_chat/` for complete working examples.
...
| `.env.example` | Credential variables and setup pointers |
| `cli-config.yaml.example` | Non-secret platform configuration |
