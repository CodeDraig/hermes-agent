...
TIPS = [
    ...
    "Set fallback_providers in config.yaml to automatically fail over to a backup provider.",
    ...
    'hermes fallback manages the fallback_providers chain interactively — no hand-editing config.yaml.',
