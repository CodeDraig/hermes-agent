...
<table>
<tr><td><b>Una interfaz de terminal real</b></td><td>CLI interactiva basada en prompt-toolkit, con edición multilínea, autocompletado de comandos, historial de conversaciones, interrupción y redirección, y salida de herramientas en streaming.</td></tr>
...
> **Nota:** En Windows nativo, Hermes funciona sin WSL — la CLI, el gateway y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/NousResearch/hermes-agent/issues).
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://github.com/NousResearch/hermes-agent). En Termux, Hermes instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `hermes portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://github.com/NousResearch/hermes-agent).
...
Para las listas de comandos completas, consulta la [guía de CLI](https://github.com/NousResearch/hermes-agent) y la [guía del Gateway de Mensajería](https://github.com/NousResearch/hermes-agent).
